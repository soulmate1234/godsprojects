...
touch(Template(r"tpl1605840269364.png", record_pos=(-0.119, 0.261), resolution=(720, 1440)))
sleep(1.0)
sleep(1.0)
...
swipe(Template(r"tpl1605841772915.png", record_pos=(-0.022, -0.017), resolution=(720, 1440)), vector=[-0.4944, -0.0028])
